    ...
    <body>
        <div class="container" id="edit_container">
            <div class="row">
                <!-- <div class="col-1"></div> -->
                <div class="col-12">
                    <h1 class="text-center tieude mt-3">CHỈNH SỬA BÀI VIẾT</h1>
                    <form action="ketquachinhsuabaiviet.php?id=<?php echo $idbaiviet; ?><?php echo $page; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-left">
                            ...
                            <textarea id="mota_thembaiviet" name="mota_thembaiviet" minlength="100" required><?php echo $mota; ?></textarea>
                        </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-sm-12 col-md-3 col-12">
                                    <?php
                                        if ($_SESSION['email'] == "admin@gmail.com"){
                                            echo '<button type="button" name="huy" onclick="window.location.href=\'trangquantrivien.php?page=' . $_GET['page'] . '\'" class="btn btn-primary btn-block background_color_and_width bg_color_and_width nutpopup_1"><a href="trangquantrivien.php" style="color: white; text-decoration:none;"><b>HỦY</b></a></button>';
                                        }
                                        else{
