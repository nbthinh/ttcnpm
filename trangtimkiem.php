    ...
    <body>
        ...
        <section>
            <div class="container" id="containerchua">            
                ...
                $timkiemsach = addslashes($_POST['timkiemsach']);
                //Nếu $search rỗng thì báo lỗi, tức là người dùng chưa nhập liệu mà đã nhấn submit.
                if (empty($timkiemsach) && !isset($_GET['thutu'])) {
                    echo '
                    <div class="row text-center">
                        <div class="col" id="tuadesachtuongtu">
                        <h1 style="display: inline" class="mautuadechitiet" id="sachtuongtu">~ VUI LÒNG NHẬP NỘI DUNG TÌM KIẾM ~</h1>
                        </div>
                    </div>
                    ';
                } 
                ...
                {
                    $sql = "SELECT * FROM sach WHERE Duyet_sach=1 AND Ten_sach LIKE '%$timkiemsach%'";
                    ...
                    if ($total_records ==0){
                        ...
                        <div class="row text-center">
                            <div class="col" id="tuadesachtuongtu">
                            <h1 style="display: inline" class="mautuadechitiet" id="sachtuongtu">~ KHÔNG TÌM THẤY KẾT QUẢ ~</h1>
                            </div>
                        </div>
                        ';
                    }
                    ...
                    <div class="row text-center">
                        <div class="col" id="tuadesachtuongtu">
                        <h1 style="display: inline" class="mautuadechitiet" id="sachtuongtu"> ~ KẾT QUẢ TÌM KIẾM ~</h1>
                        </div>
                    </div>
                    ';
                    ...
                    $sql = "SELECT * FROM sach WHERE Duyet_sach=1 AND Ten_sach LIKE '%$timkiemsach%' LIMIT " . $j . " ,12";
                    $result = mysqli_query($conn, $sql);
                        ...
                        if(($j + 12) >= $total_records)
                        {
                            ...
                            <div class="row">
                                <div class="col text-right marginright20">
                                    <button type="button" class="btn btn1 btn-warning" style="width: 90px" onclick="window.location.href=\'trangtimkiem.php?thutu='
                                    . strval($j - 12)
                                    .
                                    '\'">Trước</a></button>
                                </div>
