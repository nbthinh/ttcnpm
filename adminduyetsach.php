        ...
        <div class="container" id="edit_container">
            <div class="row">
                <div class="col">
                    ...
                    <form method="POST" action="process.php?state=confirm_book&id=<?php echo $idsach; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-left">
                            ...
                            <textarea id="mota" name="mota" required><?php echo $mota; ?></textarea>
                        </div>
                        ...
                        <div class="form-group text-left">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-sm-12 col-md-3 col-12">
                                    <?php 
                                        echo '<button type="button" name="huy" class="btn btn-primary btn-block background_color_and_width bg_color_and_width nutpopup_1" onclick=\'window.location.href="trangquantrivien.php"\'><b>TRỞ VỀ</b></button>';
                                    ?>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-sm-12 col-md-3 col-12">
                                    <button type="submit" name="xacnhan" class="btn btn-primary btn-block background_color_and_width bg_color_and_width nutpopup_2"><b>DUYỆT SÁCH</b></button>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-sm-12 col-md-3 col-12"></div>
                            </div>
                        </div>
