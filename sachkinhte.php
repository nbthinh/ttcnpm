...
<html lang="en">
    <head>
        <title>Trang sách kinh tế</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section>
            <div class="container" id="containerchua">            
                ...
                if (true) 
                {
                    $sql = "SELECT * FROM sach WHERE Duyet_sach=1 AND Ma_the_loai = 2";
                    ...
                    if ($total_records ==0){
                        ...
                        <div class="row text-center">
                            ...
                            <h1 style="display: inline" class="mautuadechitiet" id="sachtuongtu">~ SÁCH KINH TẾ ~</h1>
                            </div>
                        </div>
                        ';
                    }
                    ...
                    $sql = "SELECT * FROM sach WHERE Duyet_sach=1 AND Ma_the_loai = 2 LIMIT " . $j . " ,12";
                    $result = mysqli_query($conn, $sql);
                        ...
                        if(($j + 12) >= $total_records)
                        {
                            ...
                            <div class="row">
                                <div class="col text-right marginright20">
                                    <button type="button" class="btn btn1 btn-warning" style="width: 90px" onclick="window.location.href=\'sachkinhte.php?thutu='
                                    . strval($j - 12)
                                    .
                                    '\'">Trước</a></button>
                                </div>
