...
<body class="form-v4">
	<div class="page-content">
		<div class="form-v4-content">
			...
			<form class="form-detail" action="xulyquenmatkhau.php" method="post" id="myform">
				<h2>QUÊN MẬT KHẨU</h2>
				...
				<div class="form-row">
					<p>Hãy nhập địa chỉ email đăng ký, chúng tôi sẽ gửi cho bạn mật khẩu khôi phục tài khoản</p><br>
					<label for="your_email">Email</label>
					<input type="text" name="emailqmk" id="emailqmk" class="input-text" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
				</div>
				<!-- <div class="form-row">
				...
				<div class="form-row-last">
					<input type="submit" name="gui" class="register" value="Gửi">
				</div>
			</form>
		</div>
	</div>
