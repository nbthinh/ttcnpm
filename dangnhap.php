		...
		<div class="form-v4-content">
			<div class="form-left">
				...
				<div class="form-left-last">
					...
					<input type="button" name="dendangkydn" class="account" value="Chưa có tài khoản?" onclick="location.href='dangky.php';">
				</div>
			</div>
			<form class="form-detail" action="xulydangnhap.php" method="post" id="myform">
				<h2>ĐĂNG NHẬP</h2>
				...
				<div class="form-row"><p><a href="quenmatkhau.php" class="text"><b>Quên mật khẩu</b></a></p></div>
